...
# Script para limpiar migraciones y recrear desde cero
# Ejecutar desde tu máquina local

set -e  # Salir si hay algún error

echo "🚀 Limpiando migraciones y recreando base de datos..."
...
print_status "Eliminando migraciones existentes..."
ssh $SERVER_USER@$SERVER_IP "cd $SERVER_DIR && rm -rf core/migrations/__pycache__ && find core/migrations/ -name '*.py' -not -name '__init__.py' -delete"
...
print_status "Creando migraciones iniciales desde cero..."
