...
# Script para corregir completamente la configuración de archivos estáticos
# Ejecutar desde tu máquina local

set -e  # Salir si hay algún error

echo "🚀 Corrigiendo completamente la configuración de archivos estáticos..."
...
ssh $SERVER_USER@$SERVER_IP "cd $SERVER_DIR && cp directiva_agricola/settings_production.py directiva_agricola/settings_production.py.backup2"
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DB_USER', 'directiva_user'),
...
print_status "✅ Configuración completamente corregida!"
